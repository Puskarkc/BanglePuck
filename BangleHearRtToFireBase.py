...
### Code to Start Bangle using Java Script and Post Heart Rate and Temperature in Firebase.
### Author : Puskar K C
### Python inerfacing code, referenced from Bangle.js official documentation.
import asyncio
import array
import time
import pyrebase
...
#address = "E43D4199-EB93-DBE8-4565-0E8F0C3202A1" ### Puskar Watch
address = "5BCD1604-F7C7-4AA1-95D2-3190B2CCE9D3"  ### Alan Watch
...
person = "Puskar"
t = time.localtime()
current_time = time.strftime("%H:%M:%S", t) ### Not used this for Now, Want to get the Time, you can use this
...
### Write Code to exit the program.
### Puskar Will write later
